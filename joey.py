...
class HermesBrain:
    """Talk to Hermes Agent in headless mode (hermes -z), with --continue
    for multi-turn. Hermes accumulates skills/memory across sessions, which
    makes it a better long-term fit for the robot voice loop than Claude's
